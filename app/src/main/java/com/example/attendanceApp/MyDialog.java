...
public class MyDialog extends DialogFragment {
    ...
    public static final String STUDENT_UPDATE_DIALOG = "udateStudent";
    ...
    private Dialog getUpdateStudentDialog() {
        ...
        add.setText("Update");
        roll_edt.setText(roll+"");//edit er somoy name access korte parbo but name e access korte parbo na
